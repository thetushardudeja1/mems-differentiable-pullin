...
|---|:---:|---|
| **How the method works**<br><sub>`method_deep_dive.ipynb` · ~3 min</sub> | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/thetushardudeja1/mems-differentiable-pullin/blob/main/notebooks/method_deep_dive.ipynb) | Devices designed in front of you, the sensitivity map, and a finished device from a bare spec in **0.04 ms** |
| **Validation and results**<br><sub>`MEMS_differentiable_pullin.ipynb` · ~4 min</sub> | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/thetushardudeja1/mems-differentiable-pullin/blob/main/notebooks/MEMS_differentiable_pullin.ipynb) | Eight published sources checked live, the exponent reversal, and **22.86 V → 14.04 V** removed |
